...
| `git-user-name` | Git committer username, gets used when running `git commit` | `true` | `forgejo-actions[bot]` |
| `git-user-email` | Git committer email, gets used when running `git commit` | `true` | `git@bartoostveen.nl` |
